...
var ASM_CONSTS = {
 ...
 479140: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 479223: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 479292: () => { return window.innerWidth; },  
 479322: () => { return window.innerHeight; }
};
